...
class FeatureContext extends RawDrupalContext {
  ...
  // This is useful for nodes to have different timestamps even if they
  ...
  public function cleanUp() {
    foreach ($this->stuff as $deletable) {
      $deletable->delete();
    }
  }
   ...
   */
  public function iAddAMessageForTheLastCreatedContent()
  {
    $nid = $this->getLastCreatedNodeId();
   ...
   * throws \Exception;
   */
  function iViewANode($page, $title) {
    $nid = $this->getTestContentNidByTitle($title);
    if ($nid) {
